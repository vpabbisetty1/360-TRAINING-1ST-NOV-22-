...
SELECT min(Quantity) AND max(Quantity) FROM order_details;
SELECT AVG(Quantity) FROM order_details;
SELECT ProductName FROM products LIMIT 15;
SELECT SupplierName FROM suppliers WHERE SupplierName like '_A%';
SELECT CustomerName FROM customers WHERE Country BETWEEN 'Canada%' AND 'USA%';
SELECT * FROM orders WHERE OrderDate ORDER BY '2020%' AND '2021%'; 
SELECT DISTINCT city, COUNT(city) FROM Customers; 
SELECT * FROM employees WHERE NOT FirstName= 'Sanjay' OR 'Sonia';
CREATE TABLE SupplierDetail AS SELECT * FROM suppliers;
SELECT * FROM SupplierDetail;
DELETE FROM customers WHERE Country='Venezuela'; SELECT Country FROM customers;